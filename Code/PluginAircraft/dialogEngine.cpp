...
namespace Aircraft
{
	...
	void CreateEngineDialog::init()
	{
		_ui->tableWidget->horizontalHeader()->setSectionResizeMode(QHeaderView::Stretch);
		_ui->tableWidget->setRowCount(10);
		_ui->tableWidget->verticalHeader()->setVisible(false);
	}

	void CreateEngineDialog::closeEvent(QCloseEvent *)
	{

	}

	void CreateEngineDialog::reject() 
	{
		this->close();
	}

	void CreateEngineDialog::accept()
	{
	...
	void CreateEngineDialog::on_SaveButton_clicked()
	{
	...
	void CreateEngineDialog::on_ImportButton_clicked()
	{

		QFileDialog* fd = new QFileDialog(this);
		QString fileName = fd->getOpenFileName(this, tr("Open File"), "/home", tr("*.csv"));
		if (fileName == "") return;
		QFile file(fileName);
		QString line{};
	...
	void CreateEngineDialog::fillTab()
	{
