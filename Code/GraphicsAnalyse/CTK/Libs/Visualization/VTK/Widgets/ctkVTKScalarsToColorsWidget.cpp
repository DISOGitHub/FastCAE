...
void ctkVTKScalarsToColorsWidgetPrivate::setupUi(QWidget* widget)
{
  ...
  //201801 add
  this->XRangeSlider->setVisible(false);
  this->YRangeSlider->setVisible(false);
  this->topLayout_groupBox->setVisible(false);
  //201801 add
}
   ...
   , d_ptr(new ctkVTKScalarsToColorsWidgetPrivate(*this))
{
  ...
  d->setupUi(this);
  d->topLayout_groupBox->setVisible(false);
  d->XRangeSlider->setVisible(false);
  d->YRangeSlider->setVisible(false);
}
...
void ctkVTKScalarsToColorsWidget::updateCurrentPoint()
{
  ...
  /////////////2018/////////////////////////////
  emit sig_udpate_scalarBarTable();
  /////////////////////////////////////////////
